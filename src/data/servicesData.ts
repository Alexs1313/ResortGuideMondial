...
export const SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    description:
      'Reserve a table in the main restaurant, lounge, or private dining area for a planned evening inside the resort.',
  ...
  },
  {
    ...
    description:
      'Request access details for a quieter lounge area with premium seating, drinks, and a more private atmosphere.',
  ...
  },
  {
    ...
    description:
      'Request internal assistance for moving between rooms, restaurant areas, lounge spaces, and event zones.',
