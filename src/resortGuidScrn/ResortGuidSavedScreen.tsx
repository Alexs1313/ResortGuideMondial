  ...
  <Pressable
    ...
    <View style={styles.cardImageWrap}>
      ...
      <Pressable
        ...
        <Image source={resortGuidIcons.savedActive} />
      </Pressable>
...
const SavedEmpty = () => (
  <View style={styles.emptyWrap}>
    <View style={styles.emptyIconCircle}>
      <Image source={resortGuidIcons.noSaved} style={styles.emptyIcon} />
    </View>
...
export function ResortGuidSavedScreen({
  onOpenGuide,
}: SavedScreenProps): React.JSX.Element {
  const insets = useSafeAreaInsets();
  const {savedItems, toggleSave} = useResortGuidSaved();
...
const styles = StyleSheet.create({
  ...
  emptyIcon: {
    width: 24,
    height: 24,
    tintColor: resortGuidColors.muted,
  },
  emptyTitle: {
    fontFamily: 'Cinzel-Bold',
    fontSize: 16,
