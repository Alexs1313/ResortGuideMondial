...
import {
  ...
  getTagStyle,
  hasEventsOnDate,
} from '../resortGuidData/ResortGuidCalendarData';
    ...
    <View style={styles.eventCard}>
      ...
      <View style={styles.eventBody}>
        ...
        <View style={styles.locationRow}>
          <Image
            source={resortGuidIcons.location}
...
const CalendarEmpty = () => (
  <View style={styles.emptyWrap}>
    <View style={styles.emptyIconCircle}>
      <Image
        source={require('../resortGuidAssts/images/tab_calendar.png')}
...
export function ResortGuidCalendarScreen(): React.JSX.Element {
